  ...
  if (region)
    return (
      <Link
        ...
        className="flex items-center justify-center gap-2 py-3 px-6 border-2 border-gray-900 rounded-full cursor-pointer hover:bg-blue-100 hover:border-blue-500 hover:text-blue-700 hover:shadow-lg"
      >
        View {name} on map
      </Link>
    );
